        ...
        <div id="inputResult">
                            ...
                            <div class="row mb-4">
                                <div class="col">
                                    ...
                                    <div class="descr">
                                        ...
                                        данных, предпринимаемые <span class="link mark owner-name-field" id="owner-name-value" data-scroll-to="#owner-name-field">ООО "Ялтинский берег"</span> (далее&nbsp;— Оператор).
                                    </div>
                                    <div class="ol">
                                        <div class="li">
                                        ...
                                        <div class="li">
                                            ...
                                            которую Оператор может получить о&nbsp;посетителях веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://xn--90aefamahghv2bgk4p.xn--p1ai/</span>.
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="ol">
                                        ...
                                        <div class="li">
                                            ...
                                            их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://xn--90aefamahghv2bgk4p.xn--p1ai/</span>.
                                        </div>
                                        <div class="li">
                                        ...
                                        <div class="li">2.8. Персональные данные&nbsp;— любая информация,
                                            ...
                                            Пользователю веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://xn--90aefamahghv2bgk4p.xn--p1ai/</span>.
                                        </div>
                                        <div class="li">
                                        ...
                                        <div class="li">
                                            2.10. Пользователь&nbsp;— любой посетитель веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://xn--90aefamahghv2bgk4p.xn--p1ai/</span>.
                                        </div>
                                        <div class="li">
                            ...
                            <div class="row mb-4">
                                <div class="col">
                                    ...
                                    <div class="ol">
                                        <div class="li" id="hwxyUdPFl">
                                                <table class="border">
                                                    <tbody>
                                                        <tr>
                                                        <th class="border">Цель обработки</th>
                                                        <td class="border"><span class="mark link">заключение, исполнение и&nbsp;прекращение гражданско-правовых договоров</span></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="border">Персональные данные</th>
                                                        <td class="border"><ul><li><span class="mark link">фамилия, имя, отчество</span></li><li><span class="mark link">электронный адрес</span></li><li><span class="mark link">номера телефонов</span></li><li><span class="mark link">фотографии</span></li></ul></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="border">Правовые основания</th>
                                                        <td class="border"><ul><li><span class="mark link">договоры, заключаемые между оператором и&nbsp;субъектом персональных данных</span></li></ul></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="border">Виды обработки персональных данных</th>
                                                        <td class="border"><ul><li><span class="mark link">Сбор, запись, систематизация, накопление, хранение, уничтожение и&nbsp;обезличивание персональных данных</span></li></ul></td>
                                                    </tr>
                                                </tbody></table>
                                ...
                                <div class="col">
                                    ...
                                    <div class="ol">
                                        ...
                                        <div class="li">
                                            ...
                                            Оператору уведомление на&nbsp;адрес электронной почты Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">yaltabereg@mail.ru</span>
                                        ...
                                        <div class="li">
                                            ...
                                            посредством электронной почты на&nbsp;электронный адрес Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">yaltabereg@mail.ru</span>
                                ...
                                <div class="col">
                                    ...
                                    <div class="ol">
                                        <div class="li">
                                            ...
                                            к&nbsp;Оператору с&nbsp;помощью электронной почты <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">yaltabereg@mail.ru</span>.
                                        </div>
                                        <div class="li">
                                        ...
                                        <div class="li">
                                            ...
                                            в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field">https://xn--90aefamahghv2bgk4p.xn--p1ai/privacy</span>.
                                        </div>
                                    </div>
                                </div>
                            </div>
